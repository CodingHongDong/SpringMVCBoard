    	...
    	<form name="frm" action="${contextPath}/memUpdate.do" method="post">
    		...
    		<table class="table table-bordered" style="text-align: center; border: 1px solid #dddddd;">
    			...
    			<tr>
    				...
    				<td colspan="2"><input class="form-control" type="text" id="memName" name="memName" maxlength="20" value="${mvo.memName}"></td>
    			</tr>
    			<tr>
    				<td style="width: 110px; vertical-align: middle;">나이</td>
    				<td colspan="2"><input class="form-control" type="number" id="memAge" name="memAge" maxlength="20" value="${mvo.memAge}"></td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				...
    				<td colspan="2"><input class="form-control" type="email" id="memEmail" name="memEmail" maxlength="20" value="${mvo.memEmail}"></td>
    			</tr>
    			...
    			<tr>
    				<td colspan="3" style="text-align: left;">
    					<span id="passMessage" style="color: red;"></span><input type="button" class="btn btn-info btn-sm pull-right" value="수정" onclick="goUpdate()"/>
    				</td>
    			</tr>
    		</table>
